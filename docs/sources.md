...
- Test-running reviewers can instead use a permission profile that grants read access to the repository and write access only to temporary directories; this lets tools such as Jest write caches without granting source write access.
